...
class MyEventHandler(pyinotify.ProcessEvent):
    ...
    def exclude_PATH(self,pathname,_info):
        ...
        f_name = f_name.lower()
        if f_name in _info['exclude_name']:
            return True
        return False
    ...
    def write_LOG(self,eventType,index,pathname,_info):
        ...
        public.run_thread(self.send_dingding,(msg,))
        # 备份和木马检测
    ...
    def send_dingding(self,msg):
        ...
        public.send_dingding(msg,True,'文件监控事件')
        public.send_mail('【堡塔文件监控】告警事件',msg,True,'文件监控事件')
