...
class pgsql_manager_main:
        ...
        with open("{}/postgresql.conf".format(data_directory)) as f:
            for i in f:
                if i.strip().startswith("shared_buffers"):
                    ...
                    shared_buffers = i.split("=")[1]
                shared_buffers_num = re.match(r'\d+', shared_buffers.strip()).group() if re.match(r'\d+', shared_buffers.strip()) else ""
                ...
                if i.strip().startswith("work_mem"):
                    ...
                    work_mem = i.split("=")[1]
                work_mem_num = re.match(r'\d+', work_mem.strip()).group() if re.match(r'\d+', work_mem.strip()) else ""
                ...
                if i.strip().startswith("effective_cache_size"):
                    ...
                    effective_cache_size = i.split("=")[1]
                effective_cache_size_num = re.match(r'\d+', effective_cache_size.strip()).group() if re.match(r'\d+', effective_cache_size.strip()) else ""
                ...
                if i.strip().startswith("temp_buffers "):
                    ...
                    temp_buffers = i.split("=")[1]
                temp_buffers_num = re.match(r'\d+', temp_buffers.strip()).group() if re.match(r'\d+', temp_buffers.strip()) else ""
                ...
                if i.strip().startswith("max_connections"):
                    ...
                    max_connections = i.split("=")[1]
                max_connections_num = re.match(r'\d+', max_connections.strip()).group() if re.match(r'\d+', max_connections.strip()) else ""
                ...
                if i.strip().startswith("max_prepared_transactions"):
                    ...
                    max_prepared_transactions = i.split("=")[1]
                max_prepared_transactions_num = re.match(r'\d+', max_prepared_transactions.strip()).group() if re.match(r'\d+', max_prepared_transactions.strip()) else ""
                ...
                if i.strip().startswith("max_stack_depth "):
                    ...
                    max_stack_depth = i.split("=")[1]
                max_stack_depth_num = re.match(r'\d+', max_stack_depth.strip()).group() if re.match(r'\d+', max_stack_depth.strip()) else ""
                ...
                if i.strip().startswith("bgwriter_lru_maxpages "):
                    ...
                    bgwriter_lru_maxpages = i.split("=")[1]
                bgwriter_lru_maxpages_num = re.match(r'\d+', bgwriter_lru_maxpages.strip()).group() if re.match(r'\d+', bgwriter_lru_maxpages.strip()) else ""
                ...
                if i.strip().startswith("max_worker_processes "):
                    ...
                    max_worker_processes = i.split("=")[1]
                max_worker_processes_num = re.match(r'\d+', max_worker_processes.strip()).group() if re.match(r'\d+', max_worker_processes.strip()) else ""
                ...
                if i.strip().startswith("listen_addresses"):
                    ...
                    listen_addresses = i.split("=")[1]
                listen_addresses = re.match(r"\'.*?\'", listen_addresses.strip()).group() if re.match(r"\'.*?\'", listen_addresses.strip()) else ""
    ...
    def Install_uninstall(self, args):  # 安装卸载pgsql
        ...
        if int(args.get_pgsql_version) != 0 and int(args.get_pgsql_install_info) != 0:
            ...
            pgsql_install_info = [
                {"pgsql_version": "postgresql 13.0", "down_url": bt_down_url + "/src/postgresql-13.0.tar.gz"},
                {"pgsql_version": "postgresql 12.4", "down_url": bt_down_url + "/src/postgresql-12.4.tar.gz"},
                ...
                {"pgsql_version": "postgresql 9.6.6", "down_url": bt_down_url + "/src/postgresql-9.6.6.tar.gz"}
            ]
