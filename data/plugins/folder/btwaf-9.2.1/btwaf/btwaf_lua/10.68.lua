...
local geo2 =nil 
white_rule =false
local is_ok,xss_engine_status = pcall(function()
     return require "xss_engine"
end)
if not is_ok then 
    local xss_engine={}
    xss_engine.xss =function(x) return false  end
else
   local xss_engine=xss_engine_status
end
